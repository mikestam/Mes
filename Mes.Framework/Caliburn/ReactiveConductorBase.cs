namespace Mes.Framework
{
    ...
    public abstract class ReactiveConductorBase<T> : ReactiveScreen, IConductor, INotifyPropertyChangedEx, INotifyPropertyChanged, IParent<T>, IParent
    {
        private ICloseStrategy<T> closeStrategy;

        public event EventHandler<ActivationProcessedEventArgs> ActivationProcessed;

        protected ReactiveConductorBase()
        {
            this.ActivationProcessed = delegate (object param0, ActivationProcessedEventArgs param1) {
            };
        }
